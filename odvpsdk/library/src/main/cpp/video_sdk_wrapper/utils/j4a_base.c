...
const char* J4A_GetStringUTFChars(JNIEnv *env, jstring str, jboolean* is_copy)
{
    if (!str)
        return "";
...
int J4A_GetIntField(JNIEnv *env, jclass class, const char* field_name, jobject object)
{
    jfieldID field_id = J4A_GetFieldID__catchAll(env, class, field_name, "I");
    jint value = (*env)->GetIntField(env, object, field_id);
    return value;
}

double J4A_GetDoubleField(JNIEnv *env, jclass class, const char* field_name, jobject object)
{
    jfieldID field_id = J4A_GetFieldID__catchAll(env, class, field_name, "D");
    jdouble value = (*env)->GetDoubleField(env, object, field_id);
    return value;
}

unsigned char J4A_GetBooleanField(JNIEnv *env, jclass class, const char* field_name, jobject object)
{
    jfieldID field_id = J4A_GetFieldID__catchAll(env, class, field_name, "Z");
    jboolean value = (*env)->GetBooleanField(env, object, field_id);
    return value;
}
