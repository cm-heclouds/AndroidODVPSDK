...
)
{
    ...
    */
    ...
    do {
        ...
        /* drop subsequent samples when current size of sample is wrong */
        if (h264_nal_leng > (n_video_sample - nal_leng_acc - 4))
        {
            break;
        }
